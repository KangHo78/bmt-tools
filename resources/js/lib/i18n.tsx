...
const copy: Copy[] = [
    ...
    ["Ajukan Pinjaman", "Ajukan Peminjaman", "Request a Loan"],
    ["Ajukan Peminjaman", "Ajukan Peminjaman", "Request a Loan"],
    ...
    ["Pinjaman Aktif", "Pinjaman Aktif", "Active Loans"],
    [
    ...
    // Loans and handovers
    ["Loan register", "Daftar peminjaman", "Loan Register"],
    ["Daftar peminjaman", "Daftar peminjaman", "Loan List"],
    [
        "Seluruh permohonan, pinjaman aktif, dan histori pengembalian.",
        "Seluruh permohonan, pinjaman aktif, dan riwayat pengembalian.",
        "All requests, active loans, and return history.",
    ],
    ["Pinjaman Baru", "Pinjaman Baru", "New Loan"],
    ["Belum ada peminjaman", "Belum ada peminjaman", "No loans yet"],
    ["Input Peminjaman", "Input Peminjaman", "Loan Details"],
    ["Kuota Peminjaman", "Kuota Peminjaman", "Loan Allowance"],
    ["Peminjaman Bulanan", "Peminjaman Bulanan", "Monthly Loans"],
    ["Pinjaman Luar Area", "Pinjaman Luar Area", "Off-site Loan"],
    ["Perpanjangan Luar Area", "Perpanjangan Luar Area", "Off-site Extension"],
    ["New loan request", "Permohonan pinjaman baru", "New Loan Request"],
    ...
    [
        ...
        "Requires a loan period, request letter, and approval.",
    ],
    ...
    ["Buat Peminjaman", "Buat Peminjaman", "Create Loan"],
    ["Aturan peminjaman", "Aturan peminjaman", "Loan Rules"],
    [
    ...
    ["Loan passport", "Paspor peminjaman", "Loan Passport"],
    ...
    [
        ...
        "Review off-site loans and extension requests.",
    ],
    [
        "Tidak ada approval pinjaman",
        "Tidak ada persetujuan pinjaman",
        "No loan requests are awaiting approval",
    ],
    [
    ...
    [
        ...
        "Pilih akun yang berhak melihat antrean serta menyetujui atau menolak pinjaman dan perpanjangan luar area.",
        "Choose the accounts authorized to review, approve, or reject off-site loans and extensions.",
    ],
    [
