...
const copy: Copy[] = [
    ...
    ["Kotak Keputusan", "Kotak Keputusan", "Decision Inbox"],
    ["Menunggu Approval", "Menunggu Persetujuan", "Awaiting Approval"],
    [
        "Buka detail transaksi untuk memeriksa data sebelum memberikan keputusan.",
        "Buka detail transaksi untuk memeriksa data sebelum memberikan keputusan.",
        "Open the transaction details to review the data before making a decision.",
    ],
    ["Transaksi", "Transaksi", "Transaction"],
    ["Keperluan & Alat", "Keperluan dan Alat", "Purpose & Tools"],
    ["Periode", "Periode", "Period"],
    ["Approval Owner", "Persetujuan Owner", "Owner Approval"],
    ["Approval Logistik", "Persetujuan Logistik", "Logistics Approval"],
    [
        "Tidak ada approval yang menunggu keputusan Anda.",
        "Tidak ada persetujuan yang menunggu keputusan Anda.",
        "No approvals are awaiting your decision.",
    ],
    ...
    ["Batch Penerimaan", "Batch Penerimaan", "Receipt Batches"],
    [
        "Kelola setiap penerimaan sebagai satu batch, lalu telusuri unit individual di dalamnya.",
        "Kelola setiap penerimaan sebagai satu batch, lalu telusuri unit individual di dalamnya.",
        "Manage each receipt as one batch, then trace the individual units within it.",
    ],
    [
        "Cari kode penerimaan, referensi, owner, atau barang...",
        "Cari kode penerimaan, referensi, owner, atau barang...",
        "Search receipt code, reference, owner, or item...",
    ],
    ["Kode Penerimaan", "Kode Penerimaan", "Receipt Code"],
    ["Isi Batch", "Isi Batch", "Batch Contents"],
    ["Jumlah", "Jumlah", "Quantity"],
    ["Dokumen", "Dokumen", "Document"],
    ["Tanpa referensi", "Tanpa referensi", "No reference"],
    ["Diterima oleh", "Diterima oleh", "Received by"],
    ["jenis barang", "jenis barang", "item types"],
    [
    ...
    [
        "Kode penerimaan dan unit di dalam batch tidak berubah.",
        "Kode penerimaan dan unit di dalam batch tidak berubah.",
        "The receipt code and units in the batch will not change.",
    ],
    ["Catatan penerimaan", "Catatan penerimaan", "Receipt Notes"],
    [
    ...
    [
        ...
        "Hapus dokumen pendukung saat ini",
        "Remove the current supporting document",
    ],
    ...
    ["Kasus Terkait", "Kasus Terkait", "Related Cases"],
    ["Perlu Tindak Lanjut", "Perlu Tindak Lanjut", "Follow-up Required"],
    ["Buka Kasus", "Buka Kasus", "Open Case"],
    ["Kelola Kasus", "Kelola Kasus", "Manage Case"],
    [
        "Cari kasus berdasarkan peminjam, barang, transaksi, kode unit, atau token fisik.",
        "Cari kasus berdasarkan peminjam, barang, transaksi, kode unit, atau token fisik.",
        "Search cases by borrower, item, transaction, unit code, or physical token.",
    ],
    [
        "Nama peminjam, barang, TRX, kode unit, token, atau nomor kasus...",
        "Nama peminjam, barang, TRX, kode unit, token, atau nomor kasus...",
        "Borrower name, item, TRX, unit code, token, or case number...",
    ],
    ["Hapus pencarian", "Hapus pencarian", "Clear search"],
    ["Cari Kasus", "Cari Kasus", "Search Cases"],
    ["kasus ditemukan", "kasus ditemukan", "cases found"],
    ["Peminjam", "Peminjam", "Borrower"],
    ["Barang", "Barang", "Item"],
    ["Token Fisik", "Token Fisik", "Physical Token"],
    ["Kasus tidak ditemukan", "Kasus tidak ditemukan", "No cases found"],
    ...
    ["Management reports", "Laporan manajemen", "Management Reports"],
    ["Pusat Laporan", "Pusat Laporan", "Reports Center"],
    [
        "Setiap laporan kini berdiri sendiri agar lebih mudah dibaca, dicetak, dan diekspor.",
        "Setiap laporan kini berdiri sendiri agar lebih mudah dibaca, dicetak, dan diekspor.",
        "Each report stands on its own so it is easier to read, print, and export.",
    ],
    ["Laporan Aset", "Laporan Aset", "Asset Reports"],
    [
        "Posisi, kondisi, lokasi, dan status seluruh unit aset.",
        "Posisi, kondisi, lokasi, dan status seluruh unit aset.",
        "Position, condition, location, and status of all asset units.",
    ],
    ["Laporan Peminjaman", "Laporan Peminjaman", "Lending Reports"],
    [
        "Riwayat transaksi, volume bulanan, dan status peminjaman.",
        "Riwayat transaksi, volume bulanan, dan status peminjaman.",
        "Transaction history, monthly volume, and lending status.",
    ],
    ["Pengguna Aktif", "Pengguna Aktif", "Active Users"],
    [
        "Peminjam yang masih memegang unit dan tenggatnya.",
        "Peminjam yang masih memegang unit dan tenggatnya.",
        "Borrowers who still hold units and their due dates.",
    ],
    ["Item Dipinjam", "Item Dipinjam", "Borrowed Items"],
    [
        "Sirkulasi aktif yang dikelompokkan berdasarkan jenis alat.",
        "Sirkulasi aktif yang dikelompokkan berdasarkan jenis alat.",
        "Active circulation grouped by tool type.",
    ],
    ["Laporan Audit", "Laporan Audit", "Audit Reports"],
    [
        "Rekap stock opname, cakupan, progres, dan hasil pemeriksaan.",
        "Rekap stock opname, cakupan, progres, dan hasil pemeriksaan.",
        "Stock opname summary, coverage, progress, and inspection results.",
    ],
    ["Laporan Kasus", "Laporan Kasus", "Case Reports"],
    [
        "Kasus kerusakan dan kehilangan beserta progres penyelesaiannya.",
        "Kasus kerusakan dan kehilangan beserta progres penyelesaiannya.",
        "Damage and loss cases together with their resolution progress.",
    ],
    ["Buka laporan", "Buka laporan", "Open report"],
    ["Gap analysis", "Analisis kesenjangan", "Gap Analysis"],
    ["Laporan yang belum tersedia", "Laporan yang belum tersedia", "Reports not yet available"],
    [
        "Data dasarnya sudah dicatat oleh modul operasional. Tiga laporan ini paling masuk akal untuk tahap berikutnya.",
        "Data dasarnya sudah dicatat oleh modul operasional. Tiga laporan ini paling masuk akal untuk tahap berikutnya.",
        "The underlying data is already captured by the operations modules. These three reports are the most practical next step.",
    ],
    ["Pemeliharaan & Biaya", "Pemeliharaan dan Biaya", "Maintenance & Costs"],
    ["jadwal, downtime, vendor, dan total biaya", "jadwal, downtime, vendor, dan total biaya", "schedules, downtime, vendors, and total costs"],
    ["Penerimaan & Mutasi", "Penerimaan dan Mutasi", "Receiving & Transfers"],
    ["aset masuk dan perpindahan antar lokasi", "aset masuk dan perpindahan antar lokasi", "incoming assets and transfers between locations"],
    ["Utilisasi Alat", "Utilisasi Alat", "Tool Utilization"],
    ["alat paling sering/jarang digunakan dan idle time", "alat paling sering/jarang digunakan dan idle time", "most and least used tools and idle time"],
    ["Belum tersedia", "Belum tersedia", "Not yet available"],
    ["Asset register", "Daftar aset", "Asset Register"],
    ["Circulation history", "Riwayat sirkulasi", "Circulation History"],
    ["Stock opname", "Stock opname", "Stock Opname"],
    ["Current custody", "Penguasaan saat ini", "Current Custody"],
    ["Active circulation", "Sirkulasi aktif", "Active Circulation"],
    ["Damage & loss register", "Daftar kerusakan dan kehilangan", "Damage & Loss Register"],
    ["Ekspor Aset", "Ekspor Aset", "Export Assets"],
    ["Ekspor Peminjaman", "Ekspor Peminjaman", "Export Lendings"],
    ["Ekspor Audit", "Ekspor Audit", "Export Audits"],
    ["Ekspor Pengguna", "Ekspor Pengguna", "Export Users"],
    ["Ekspor Item", "Ekspor Item", "Export Items"],
    ["Ekspor Kasus", "Ekspor Kasus", "Export Cases"],
    ["Cetak / PDF", "Cetak / PDF", "Print / PDF"],
    ["Detailed register", "Rincian data", "Detailed Register"],
    ["Rincian Data", "Rincian Data", "Data Details"],
    ["Cari dalam laporan...", "Cari dalam laporan...", "Search this report..."],
    ["Tidak ada data laporan", "Tidak ada data laporan", "No report data"],
    [
        "Ubah pencarian atau periksa kembali saat data sudah tersedia.",
        "Ubah pencarian atau periksa kembali saat data sudah tersedia.",
        "Change your search or check again when data is available.",
    ],
    ["Status Unit", "Status Unit", "Unit Status"],
    ["Distribusi transaksi", "Distribusi transaksi", "Transaction Breakdown"],
    ["Status Peminjaman", "Status Peminjaman", "Lending Status"],
    ["Unit Diperiksa", "Unit Diperiksa", "Units Inspected"],
    ["Distribusi kondisi", "Distribusi kondisi", "Condition Breakdown"],
    ["Total Transaksi", "Total Transaksi", "Total Transactions"],
    ["Total Audit", "Total Audit", "Total Audits"],
    ["Total Kasus", "Total Kasus", "Total Cases"],
    ["Pengguna", "Pengguna", "Users"],
    ["Transaksi Aktif", "Transaksi Aktif", "Active Transactions"],
    ["Unit Dipegang", "Unit Dipegang", "Units Held"],
    ["Jenis Alat", "Jenis Alat", "Tool Types"],
    ["Unit Dipinjam", "Unit Dipinjam", "Units on Loan"],
    ["Belum Selesai", "Belum Selesai", "Open"],
    ["Kasus / Unit", "Kasus / Unit", "Case / Unit"],
    ["Penanggung Jawab", "Penanggung Jawab", "Person Responsible"],
    ["Penyelesaian", "Penyelesaian", "Resolution"],
    ["Dokumen", "Dokumen", "Documents"],
    ["Tanpa institusi", "Tanpa institusi", "No institution"],
    ["Alat tidak diketahui", "Alat tidak diketahui", "Unknown tool"],
    ["Dibuat", "Dibuat", "Created"],
    ["Audit", "Audit", "Audit"],
    ["Cakupan", "Cakupan", "Coverage"],
    ["Jadwal", "Jadwal", "Schedule"],
